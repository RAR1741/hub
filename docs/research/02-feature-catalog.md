...
- **Decision:** Shipped v1 — inventory + check log + student deletion requests ([#75](https://github.com/RAR1741/hub/issues/75)); checkout/certifications/reservations deferred.
