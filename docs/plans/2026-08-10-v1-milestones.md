...
|---|---|---|---|
| 1 | **Foundation & auth** | Next.js + Supabase scaffold, core schema (person, account_request, kiosk_device, app_setting), RLS default-deny, student-ID sessions, mentor Google OAuth with allowlist + first-user-admin bootstrap, `getViewer()`/role enforcement, login page, CI | [2026-08-10-m1-foundation-auth.md](2026-08-10-m1-foundation-auth.md) |
